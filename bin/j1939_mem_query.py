...
if __name__ == "__main__":
    ...
    bus = j1939.Bus(channel='can0', bustype='socketcan', j1939_filters=[{'pgn':0xd800}])
    print ("bus: ", bus)
    pgn = j1939.PGN()
    pgn.value = 0xd900
    print ("pgn: ", pgn)
    aid = j1939.ArbitrationID(priority=7, pgn=pgn, source_address=0x22, destination_address=0x17)
    print("aid: ", aid)
